...
public class TestRealSearch {
	...
	public void testNEConstant() {
		...
		constraints.add(new RealConstraint(new RealVariable("test1", 2.35082,
		        -1000000.0, 1000000.0), Comparator.NE, new RealConstant(2.35082)));
	...
	public void testLEConstant() {
		...
		constraints.add(new RealConstraint(new RealVariable("test1", 5.35086,
		        -1000000.0, 1000000.0), Comparator.LE, new RealConstant(2.35082)));
	...
	public void testLTConstant() {
		List<Constraint<?>> constraints = new ArrayList<Constraint<?>>();
		constraints.add(new RealConstraint(new RealVariable("test1", 5.35086,
		        -1000000.0, 1000000.0), Comparator.LT, new RealConstant(2.35082)));
	...
	public void testEQVariable() {
		...
		constraints.add(new RealConstraint(new RealVariable("test1", var1,
		        -1000000.0, 1000000.0), Comparator.EQ, new RealVariable("test2", var2,
		        -1000000.0, 1000000.0)));
	...
	public void testNEVariable() {
		...
		List<Constraint<?>> constraints = new ArrayList<Constraint<?>>();
		constraints.add(new RealConstraint(new RealVariable("test1", var1,
		        -1000000.0, 1000000.0), Comparator.NE, new RealVariable("test2", var2,
		        -1000000.0, 1000000.0)));
	...
	public void testLEVariable() {
		...
		List<Constraint<?>> constraints = new ArrayList<Constraint<?>>();
		constraints.add(new RealConstraint(new RealVariable("test1", var1,
		        -1000000.0, 1000000.0), Comparator.LE, new RealVariable("test2", var2,
		        -1000000.0, 1000000.0)));
	...
	public void testLTVariable() {
		...
		List<Constraint<?>> constraints = new ArrayList<Constraint<?>>();
		constraints.add(new RealConstraint(new RealVariable("test1", var1,
		        -1000000.0, 1000000.0), Comparator.LT, new RealVariable("test2", var2,
		        -1000000.0, 1000000.0)));
	...
	public void testGEVariable() {
		...
		List<Constraint<?>> constraints = new ArrayList<Constraint<?>>();
		constraints.add(new RealConstraint(new RealVariable("test1", var1,
		        -1000000.0, 1000000.0), Comparator.GE, new RealVariable("test2", var2,
		        -1000000.0, 1000000.0)));
	...
	public void testGTVariable() {
		...
		List<Constraint<?>> constraints = new ArrayList<Constraint<?>>();
		constraints.add(new RealConstraint(new RealVariable("test1", var1,
		        -1000000.0, 1000000.0), Comparator.GT, new RealVariable("test2", var2,
		        -1000000.0, 1000000.0)));
