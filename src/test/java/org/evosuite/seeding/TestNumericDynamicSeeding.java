 ...
 *
 */
public class TestNumericDynamicSeeding extends SystemTest {
	...
	public void testDynamicSeedingDoubleOff() {
		...
		Properties.DYNAMIC_POOL = 0.5d; // Probability of picking value from constants pool
		ConstantPoolManager.getInstance().reset();
	...
	public void testDynamicSeedingFloatOff() {
		...
		Properties.DYNAMIC_POOL = 0; // Probability of picking value from constants pool
		ConstantPoolManager.getInstance().reset();
	...
	public void testDynamicSeedingLong() {
		...
		Properties.DYNAMIC_POOL = 0.5; // Probability of picking value from constants pool
		ConstantPoolManager.getInstance().reset();
	...
	public void testDynamicSeedingInt() {
		...
		Properties.DYNAMIC_POOL = 1d / 3d; // Probability of picking value from constants pool
		ConstantPoolManager.getInstance().reset();
