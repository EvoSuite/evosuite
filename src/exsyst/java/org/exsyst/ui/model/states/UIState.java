...
import org.exsyst.ui.GraphVizDrawable;
import org.exsyst.ui.GraphVizEnvironment;
import org.exsyst.ui.YWorksDrawable;
	...
	public synchronized void addTransition(DescriptorBoundUIAction<?> action, UIState toState) {
		if (!this.transitions.containsKey(action)) {
			...
			if (prevState instanceof AmbigueUIState) {
				...
				System.out.println("Adding ambigue state " + newState);
				System.out.println("New ambigue states: " + this.graph.ambigueStates);
