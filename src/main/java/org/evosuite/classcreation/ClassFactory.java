...
public class ClassFactory {
	...
	private boolean compileClass(String sourceFileName) {
		...
		int compilationResult = compiler.run(null, null, nullOutputStream, sourceDir
		        + sourceFileName);
		...
		Utils.moveFile(new File(sourceDir + compiledFileName), new File(classDir
		        + compiledFileName));
	...
	private String generateComment() {
		...
		String comment = "// Copyright (C) 2010 Saarland University"
		        ...
		        + lineSeparator + "// (at your option) any later version."
		        ...
		        + lineSeparator + "// GNU Lesser Public License for more details."
		        + lineSeparator + "//" + lineSeparator
		        + "// You should have received a copy of the GNU Lesser Public License"
		        + lineSeparator
		        + "// along with EvoSuite.  If not, see <http://www.gnu.org/licenses/>."
		        + lineSeparator + "//" + lineSeparator + "// Auto-generated class"
		        + lineSeparator + lineSeparator;
		return comment;
	}
