...
public class BooleanHelper<E> {
    ...
    public static boolean RevertIntToBoolean(int i) {
        log.debug("RevertIntToBoolean:" + String.valueOf(i) + "->" + String.valueOf(i > 0));
        return i > 0;
    }

    public static int convertBooleanToInt(boolean b) {
        log.debug("convertBooleanToInt:" + String.valueOf(b) + "->" + String.valueOf(b ? 1 : -1));
        return b ? 1 : -1;
    }
    ...
    public static boolean popParameterBooleanFromInt() {
        ...
        boolean result = i > 0;
        log.debug("popParameterBooleanFromInt:" + String.valueOf(i) + "->" + String.valueOf(result));
        return result;
    }
    ...
    public static int isInstanceOf(Object o, Class c) {
        if (o == null) {
            ...
            log.debug("isInstanceOf:" + String.valueOf(c.isAssignableFrom(o.getClass()) ? 1 : -1));
