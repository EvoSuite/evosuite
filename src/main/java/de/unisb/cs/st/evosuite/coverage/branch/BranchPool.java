 ...
 * 
 * The addBranch()-Method gets called by the CFGMethodAdapter whenever it detects 
 * a CFGVertex that corresponds to a Branch in the class under test. 
 * 
 * @author Andre Mis
 */
public class BranchPool {
	...
	/**
	 * Get called by the CFGMethodAdapter whenever it detects a CFGVertex
	 * that corresponds to a Branch in the class under test.
	 * 
	 * @param v CFGVertex of a Branch
	 */
	...
	/**
	 * Gets called by the CFGMethodAdapter when it detects a Method without any Branches.
	 * 
	 * @param methodName Unique methodName of a method without Branches
	 */
	 ...
	 * @return If there is a Branch with the given branchID this method returns its bytecodeID, -1 otherwise
	 */
