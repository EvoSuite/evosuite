...
public class VariableReferenceImpl implements VariableReference {
	...
	public VariableReference clone() {
		...
		/*
		 * VariableReference copy = new VariableReference(type, statement); if
		 * (array != null) { copy.array = array.clone(); copy.array_index =
		 * array_index; copy.array_length = array_length; } return copy;
		 */
	}
	...
	public boolean equals(Object obj) {
		return super.equals(obj); // We can use the object equals as each
									// VariableReference is only defined once
	}
	...
	public String toString() {
		return "VariableReference: Statement " + getStPosition() + ", type " + type.getTypeName();
	}
}
