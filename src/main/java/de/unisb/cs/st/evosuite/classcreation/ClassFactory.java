...
public class ClassFactory {
	 ...
	 * 
	 * @param clazz abstract class.
	 * @return class object iff class stub was successfully created
	 * and loaded into current context, otherwise returns null.
	 */
	 ...
	 * 
	 * @return class object iff class was successfully loaded, 
	 * null otherwise.
	 */
	...
	/**
	 * Compile stub source file and write compiled file to 
	 * {@code classDir}.
	 *  
	 ...
	 *  
	 * @param unit CompilationUnit with source code.
	 * @return null if any problem occurred, otherwise returns
	 * name of the file with source code. 
	 */
	...
	/**
	 * Creates license comment for the abstract class stub.
	 * This is done in a such ugly way, since comment generation in
	 * AST is very difficult. 
	 * 
	...
	private String generateComment(){
		...
		String comment = "// Copyright (C) 2010 Saarland University" + 
