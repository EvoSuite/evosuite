 ...
 * 
 * When given an instruction this factory asks the DefUsePool whether it knows
 * this instruction. If it does the pool reveals the initially assigned
 * defUseIDs which are then put into the respective constructors.
 * 
 * @author Andre Mis
 */
public class DefUseFactory {
	...
	/**
	 * Convenience method to offer DefUse-Functionality for when it doesn't
	 * matter whether a Definition or Use is returned
	 * 
	 * Returns a Definition instance given a BytecodeInstruction for which
	 * isDefinition() is true Otherwise returns a Use instance given a
	 * BytecodeInstruction for which isUse() is true
	 * 
	 * WARNING: when given the wrap for an IINC this method will return a
	 * Definition
	 */
