	...
	public boolean keepOffspring(Chromosome parent1, Chromosome parent2, Chromosome offspring1, Chromosome offspring2) {
		...
		if (Properties.CHECK_PARENTS_LENGTH) {
			if (((fitness_offspring == fitness_parents) && (getLengthSum((TestChromosome) offspring1,
					(TestChromosome) offspring2) <= getLengthSum((TestChromosome) parent1, (TestChromosome) parent2)))) {
				return true;
			}
		} else {
		 ...
		 * getLengthSum((TestChromosome)offspring1, (TestChromosome)offspring2)
		 * <= getLengthSum((TestChromosome)parent1, (TestChromosome)parent2))) {
		 * return true; }
		 */
