...
public class ScheduleLogWrapper implements StatementInterface {
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#addAssertion(de.unisb
	 * .cs.st.evosuite.assertion.Assertion)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#equals(de.unisb.cs
	 * .st.evosuite.testcase.StatementInterface)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#execute(de.unisb.
	 * cs.st.evosuite.testcase.Scope, java.io.PrintStream)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#getAssertionCode()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#getBytecode(org.objectweb
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#getCode(java.lang
	 * .Throwable)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#getDeclaredExceptions
	 * ()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.unisb.cs.st.evosuite.testcase.StatementInterface#
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#getVariableReferences
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#isValidException(
	 * java.lang.Throwable)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#references(de.unisb
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#removeAssertion(de
	 * .unisb.cs.st.evosuite.assertion.Assertion)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.unisb.cs.st.evosuite.testcase.StatementInterface#removeAssertions()
	 */
	@Override
