...
public class SourceCodeGenerator {
	...
	private Expression generatePrimitiveExpression(Type type) {
		...
		if (primitiveType.getPrimitiveTypeCode().equals(PrimitiveType.BOOLEAN)) {
			rememberFieldParams(ast.newBooleanLiteral(false), ast.newPrimitiveType(PrimitiveType.BOOLEAN),
		...
		if (primitiveType.getPrimitiveTypeCode().equals(PrimitiveType.CHAR)) {
			...
			rememberFieldParams(cl, ast.newPrimitiveType(PrimitiveType.CHAR), ast.newPrimitiveType(PrimitiveType.CHAR));
		}

		if (primitiveType.getPrimitiveTypeCode().equals(PrimitiveType.BYTE)) {
			rememberFieldParams(ast.newNumberLiteral("0"), ast.newPrimitiveType(PrimitiveType.BYTE),
					ast.newPrimitiveType(PrimitiveType.BYTE));
		}

		if (primitiveType.getPrimitiveTypeCode().equals(PrimitiveType.DOUBLE)) {
			rememberFieldParams(ast.newNumberLiteral("0.0"), ast.newPrimitiveType(PrimitiveType.DOUBLE),
					ast.newPrimitiveType(PrimitiveType.DOUBLE));
		}

		if (primitiveType.getPrimitiveTypeCode().equals(PrimitiveType.FLOAT)) {
			rememberFieldParams(ast.newNumberLiteral("0.0f"), ast.newPrimitiveType(PrimitiveType.FLOAT),
					ast.newPrimitiveType(PrimitiveType.FLOAT));
		}

		if (primitiveType.getPrimitiveTypeCode().equals(PrimitiveType.INT)) {
			rememberFieldParams(ast.newNumberLiteral("0"), ast.newPrimitiveType(PrimitiveType.INT),
					ast.newPrimitiveType(PrimitiveType.INT));
		}

		if (primitiveType.getPrimitiveTypeCode().equals(PrimitiveType.LONG)) {
			rememberFieldParams(ast.newNumberLiteral("0l"), ast.newPrimitiveType(PrimitiveType.LONG),
					ast.newPrimitiveType(PrimitiveType.LONG));
		}

		if (primitiveType.getPrimitiveTypeCode().equals(PrimitiveType.SHORT)) {

			rememberFieldParams(ast.newNumberLiteral("0"), ast.newPrimitiveType(PrimitiveType.SHORT),
	 ...
	 */
	private void rememberFieldParams(Expression fieldValue, Type fieldType, Type fieldSetterType) {
		stubFields.add(new StubField(currentFieldName, fieldValue, fieldType, fieldSetterType));
	}
}
