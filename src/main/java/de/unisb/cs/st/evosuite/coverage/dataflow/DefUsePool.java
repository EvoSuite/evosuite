...
public class DefUsePool {
	...
	// className -> methodName -> DUVarName -> branchID -> List of Definitions
	// in that branch
	...
	// className -> methodName -> DUVarName -> branchID -> List of Uses in that
	// branch
	...
	private static <T> void initMap(Map<String, Map<String, Map<String, Map<Integer, List<T>>>>> map, String className,
			String methodName, String varName, int branchId) {
