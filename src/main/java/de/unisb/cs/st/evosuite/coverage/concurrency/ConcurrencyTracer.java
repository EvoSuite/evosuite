...
public class ConcurrencyTracer {
	...
	public static int computeDistance(List<SchedulingDecisionTuple> goal,
	...
	public static int getLevenshteinDistance(List<SchedulingDecisionTuple> s,
	        List<SchedulingDecisionTuple> t) {
		if (s == null || t == null) {
