...
public class BranchCoverageFitnessCalculations {
	...
	private static Logger logger = Logger.getLogger(BranchCoverageFitnessCalculations.class);
	
	
	/**
	 * Will become ultimate branch getDistance function
	 * 
	 * 
	 * @param branch
	 * @param value
	...
	private static ControlFlowDistance getNonRootDistance(MethodCall call, Branch branch, boolean value) {
		if(branch == null)
