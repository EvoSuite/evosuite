...
/**
 * A list of scheduling decisions.
 * Used to make generating points easier. We can just generate all of the lists and let the equals operation of this class sort the mess
 * Scheduling lists are considered equal if one list can be transformed into the other by substitution of the thread IDs
