...
public class HOMGenerator {
	...
	/*
	 * public void setSOMPopulation(int population_size) { int chromosome_length
	 * = hom_switcher.getNumMutants();
	 * 
	 * for(int i=0; i<population_size; i++) { HOMChromosome individual = new
	 * HOMChromosome(chromosome_length); individual.flip(i);
