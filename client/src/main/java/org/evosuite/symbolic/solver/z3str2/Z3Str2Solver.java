...
public class Z3Str2Solver extends SmtSolver {
...
//		}
	...
	public SolverResult solve(Collection<Constraint<?>> constraints) throws SolverTimeoutException, IOException,
		...
		String z3Cmd = Properties.Z3_STR2_PATH + " -smt2 -in ";

		ByteArrayOutputStream stdout = new ByteArrayOutputStream();
		String output;
		try {
			launchNewSolvingProcess(z3Cmd, smtQueryStr, timeout, stdout);
		...
		if (addMissingVariables()) {
			SmtModelParser parser = new SmtModelParser(initialValues);
