...
public class DSETestSuiteLocalSearch extends TestSuiteLocalSearch {
	...
	/**
	 * Applies local search to a test suite using a local search objective to measure the fitness improvement.
	 */
	@Override
	 ...
	 * @param individual
	 */
	private boolean applyDSE(TestSuiteChromosome individual) {
