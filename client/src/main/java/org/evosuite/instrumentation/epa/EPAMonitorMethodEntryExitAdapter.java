...
public class EPAMonitorMethodEntryExitAdapter extends AdviceAdapter {
	 ...
	 */
	public EPAMonitorMethodEntryExitAdapter(MethodVisitor mv, int access, String className,
	...
	public void onMethodEnter() {
		...
		mv.visitMethodInsn(Opcodes.INVOKESTATIC,
				PackageInfo.getNameWithSlash(EPAMonitor.class),
		                   "enteredMethod",
	...
	public void onMethodExit(int opcode) {
		...
		if (opcode != Opcodes.ATHROW) {
			...
			mv.visitMethodInsn(Opcodes.INVOKESTATIC,
					PackageInfo.getNameWithSlash(EPAMonitor.class),
			                   "leftMethod", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V", false);
		}
