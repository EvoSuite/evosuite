 ...
 * @author Sina
 *
 *         This class is mainly here for generating regression statistics for the
 *         http://evosuiter.sina.sh platform.
 */
public class RegressionSearchListener implements SearchListener {
  ...
  public static void writeStats(String data) {
    if (RegressionSearchListener.skipWritingStats) {
      return;
    }

    try {
      RegressionSearchListener.statsFileWriter.write(data);
  ...
  public void iteration(GeneticAlgorithm<?> algorithm) {
    ...
    int
        curAssertions =
        fitnessNotChanged ? lastAssertions : RegressionAssertionCounter.getNumAssertions(ind);
    ...
    if (curAssertions > 0) {
      ...
      ClientServices.getInstance().getClientNode()
          .trackOutputVariable(RuntimeVariable.Generated_Assertions, curAssertions);
  ...
  public void searchFinished(GeneticAlgorithm<?> algorithm) {
    ...
    if (iteration > 0) {
      ...
      ClientServices.getInstance().getClientNode()
          .trackOutputVariable(RuntimeVariable.Generated_Assertions, totalCount);
    }
