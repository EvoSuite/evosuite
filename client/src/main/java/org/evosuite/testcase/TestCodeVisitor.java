...
import org.evosuite.junit.naming.variables.DefaultNamingStrategy;
import org.evosuite.junit.naming.variables.DummyNamingStrategy;
import org.evosuite.junit.naming.variables.ExplanatoryNamingStrategy;
import org.evosuite.junit.naming.variables.MethodSignatureNamingStrategy;
import org.evosuite.junit.naming.variables.NaturalizeNamingStrategy;
import org.evosuite.junit.naming.variables.VariableNamingStrategy;
	...
	protected void visitPrimitiveAssertion(PrimitiveAssertion assertion) {
		...
		if (value == null) {
			...
			stmt += "assertEquals(" + NumberFormatter.getNumberString(value) + ", "
					+ getVariablePlaceholder(source) + ", "+NumberFormatter.getNumberString(Properties.FLOAT_PRECISION)+");";
		} else if (source.getVariableClass().equals(double.class)) {
			stmt += "assertEquals(" + NumberFormatter.getNumberString(value) + ", "
					+ getVariablePlaceholder(source) + ", "+NumberFormatter.getNumberString(Properties.DOUBLE_PRECISION)+");";
			...
			if (source.getVariableClass().equals(Float.class)) {
				stmt += "assertEquals(" + NumberFormatter.getNumberString(value)
						+ ", (float)" + getVariablePlaceholder(source) + ", "+NumberFormatter.getNumberString(Properties.FLOAT_PRECISION)+");";
			} else if (source.getVariableClass().equals(Double.class)) {
				stmt += "assertEquals(" + NumberFormatter.getNumberString(value)
						+ ", (double)" + getVariablePlaceholder(source) + ", "+NumberFormatter.getNumberString(Properties.DOUBLE_PRECISION)+");";
			} else if (value.getClass().isEnum()) {
				stmt += "assertEquals(" + NumberFormatter.getNumberString(value)
						+ ", " + getVariablePlaceholder(source) + ");";
			} else
	...
	protected void visitEqualsAssertion(EqualsAssertion assertion) {
		...
		if (source.isPrimitive() || source.isWrapperType()) {
			if (source.getVariableClass().equals(float.class)) {
				...
				if (((Boolean) value).booleanValue())
					testCode += "assertEquals((float) " + getVariablePlaceholder(source) + ", (float)"
							+ getVariablePlaceholder(dest) + ", " + NumberFormatter.getNumberString(Properties.FLOAT_PRECISION) + ");";
				else
					testCode += "assertNotEquals((float) " + getVariablePlaceholder(source) + ", (float)"
							+ getVariablePlaceholder(dest) + ", " + NumberFormatter.getNumberString(Properties.FLOAT_PRECISION) + ");";
			} else if (source.getVariableClass().equals(double.class)) {
				if (((Boolean) value).booleanValue())
					testCode += "assertEquals(" + getVariablePlaceholder(source) + ", "
				...
				if (((Boolean) value).booleanValue())
					testCode += "assertEquals((double) " + getVariablePlaceholder(source) + ", (double)"
							+ getVariablePlaceholder(dest) + ", " + NumberFormatter.getNumberString(Properties.DOUBLE_PRECISION) + ");";
				else
					testCode += "assertNotEquals((double) " + getVariablePlaceholder(source) + ", (double)"
							+ getVariablePlaceholder(dest) + ", " + NumberFormatter.getNumberString(Properties.DOUBLE_PRECISION) + ");";
			} else if(source.isWrapperType()) {
				if (((Boolean) value).booleanValue())
