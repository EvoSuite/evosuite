...
public class VarMap {
	...
	public void addAll(Map<TypeVariable<?>, GenericClassImpl> variables) throws IllegalArgumentException{
		Inputs.checkNull(variables);
		for (Entry<TypeVariable<?>, GenericClassImpl> entry : variables.entrySet()) {
