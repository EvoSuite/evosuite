...
import org.evosuite.seeding.factories.*;
...
public class TestSuiteGenerator {
    ...
    private void compileAndCheckTests(List<TestSuiteChromosome> tests) {

        if (!Properties.JUNIT_CHECK || !Properties.JUNIT_TESTS) {
            return;
        }
        ...
        for (TestSuiteChromosome test : tests) {
            /*
                current tests in the chromosome.
                checks (eg compilation) might remove tests from this list
             */
            ...
            /*
                remove all tests and put back only the ones passing the checks
             */
            test.clearTests();
        ...
        //TODO: maybe this not really needed any more
        for (TestSuiteChromosome test: tests){
