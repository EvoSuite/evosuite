...
public class TestDSETestSuiteLocalSearch {
	...
	public void test() throws NoSuchMethodException, SecurityException, ClassNotFoundException {
		...
		DSETestSuiteLocalSearch localSearch = new DSETestSuiteLocalSearch();
		boolean improved = localSearch.doSearch(suite, localSearchObjective);
		assertTrue(improved);
