...
public class SensitiveEqualitySmellTest {
    ...
    AbstractNormalizedTestCaseSmell sensitiveEquality;
    ...
    public void testToStringMethodNotUsed() throws NoSuchMethodException {
        ...
        double smellCount = this.sensitiveEquality.computeTestSmellMetric(testCase);
        double expected = 0;
    ...
    public void testFullTestSuite() throws NoSuchMethodException {
        ...
        double smellCount = this.sensitiveEquality.computeTestSmellMetric(suite);
        double expected = 2;
        assertEquals(expected, smellCount, 0.01);
    }
