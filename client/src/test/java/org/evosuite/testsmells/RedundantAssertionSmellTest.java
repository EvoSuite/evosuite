...
public class RedundantAssertionSmellTest {
    ...
    public void testWithoutRedundantAssertions() throws NoSuchMethodException {
        ...
        long smellCount = this.redundantAssertion.computeNumberOfTestSmells(testCase);
        long expectedSmellCount = 0;
        assertEquals(expectedSmellCount, smellCount);

        double computedMetric = this.redundantAssertion.computeTestSmellMetric(testCase);
    ...
    public void testFullTestSuite() throws NoSuchMethodException {
        ...
        double computedMetric = this.redundantAssertion.computeTestSmellMetric(suite);
        double expectedComputedMetric = 0.5;
        assertEquals(expectedComputedMetric, computedMetric, 0.000001);
    }
