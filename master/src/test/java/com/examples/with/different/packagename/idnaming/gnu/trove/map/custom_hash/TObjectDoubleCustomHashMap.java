...
package com.examples.with.different.packagename.idnaming.gnu.trove.map.custom_hash;

import com.examples.with.different.packagename.idnaming.gnu.trove.TDoubleCollection;
import com.examples.with.different.packagename.idnaming.gnu.trove.function.TDoubleFunction;
import com.examples.with.different.packagename.idnaming.gnu.trove.impl.Constants;
import com.examples.with.different.packagename.idnaming.gnu.trove.impl.HashFunctions;
import com.examples.with.different.packagename.idnaming.gnu.trove.impl.hash.TCustomObjectHash;
import com.examples.with.different.packagename.idnaming.gnu.trove.impl.hash.THash;
import com.examples.with.different.packagename.idnaming.gnu.trove.iterator.TDoubleIterator;
import com.examples.with.different.packagename.idnaming.gnu.trove.iterator.TObjectDoubleIterator;
import com.examples.with.different.packagename.idnaming.gnu.trove.iterator.hash.TObjectHashIterator;
import com.examples.with.different.packagename.idnaming.gnu.trove.map.TObjectDoubleMap;
import com.examples.with.different.packagename.idnaming.gnu.trove.procedure.TDoubleProcedure;
import com.examples.with.different.packagename.idnaming.gnu.trove.procedure.TObjectDoubleProcedure;
import com.examples.with.different.packagename.idnaming.gnu.trove.procedure.TObjectProcedure;
import com.examples.with.different.packagename.idnaming.gnu.trove.strategy.HashingStrategy;
