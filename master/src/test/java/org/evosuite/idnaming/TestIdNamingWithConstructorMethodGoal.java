...
public class TestIdNamingWithConstructorMethodGoal {
	@Test
	 public void testIDNamingWithDifferentArguments() throws NoSuchMethodException, ConstructionFailedException, ClassNotFoundException {
      ...
      TestFitnessFunction goal1 = new ExceptionCoverageTestFitness("<init>(Lcom/examples/with/different/packagename/idnaming/gnu/trove/map/TIntByteMap;)V"
      ...
      assertEquals("Generated test name differs from expected", "test_CreatesTUnmodifiableIntByteMap", nameTest1);
      assertEquals("Generated test name differs from expected", "test_FailsToCreateTUnmodifiableIntByteMap", nameTest2);
  }
}
