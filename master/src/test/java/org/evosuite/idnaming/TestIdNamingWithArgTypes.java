...
public class TestIdNamingWithArgTypes {
	@Test
	 public void testIDNamingWithDifferentArguments() throws NoSuchMethodException, ConstructionFailedException, ClassNotFoundException {
      ...
      assertEquals("Generated test name differs from expected", "test_ValuesWith1ArgumentOfTypeArrayByte", nameTest1);
      assertEquals("Generated test name differs from expected", "test_ValuesWith1ArgumentOfTypeArrayInt", nameTest2);
  }
}
