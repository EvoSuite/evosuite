...
public class StandardChemicalReactionSystemTest extends SystemTestBase {
  ...
  private GeneticAlgorithm<?, DEFAULT_VALUE_XXX> test(double molecular_collision_rate, int decomposition_threshold,
  ...
  public void testOnwallIneffectiveCollision() {
    GeneticAlgorithm<?, DEFAULT_VALUE_XXX> ga = test(0.0, 1_000_000, -1);
  ...
  public void testDecomposition() {
    GeneticAlgorithm<?, DEFAULT_VALUE_XXX> ga = test(0.0, 1, -1);
  ...
  public void testIntermolecularIneffectiveCollision() {
    GeneticAlgorithm<?, DEFAULT_VALUE_XXX> ga = test(1.0, -1, -1);
  ...
  public void testSynthesis() {
    GeneticAlgorithm<?, DEFAULT_VALUE_XXX> ga = test(1.0, -1, 1_000_000);
  ...
  public void testIntegration() {
    GeneticAlgorithm<?, DEFAULT_VALUE_XXX> ga = test(0.2, 500, 10);
